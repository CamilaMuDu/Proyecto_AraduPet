...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const filtrosMaterial =
        document.querySelectorAll(".filtro-material");
    ...
    /*
    Los accesorios para perro aparecen
    al abrir la página.
    */
    ...
    function aplicarFiltros() {
        ...
        const materialesSeleccionados =
            obtenerValoresMarcados(filtrosMaterial);
    ...
    /*
    Mostrar inicialmente solo accesorios
    para perro.
    */
    aplicarFiltros();
