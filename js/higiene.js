...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const filtrosUso =
        document.querySelectorAll(".filtro-uso");
    ...
    /*
    Los productos para perro aparecen
    al abrir la página.
    */
    ...
    function aplicarFiltros() {
        ...
        const usosSeleccionados =
            obtenerValoresMarcados(filtrosUso);
        ...
        productos.forEach(function (producto) {
            ...
            const coincideUso =
                ...
                usosSeleccionados.includes(
                    producto.dataset.uso
                );
    ...
    /*
    Mostrar inicialmente únicamente productos
    para perro.
    */
    aplicarFiltros();
